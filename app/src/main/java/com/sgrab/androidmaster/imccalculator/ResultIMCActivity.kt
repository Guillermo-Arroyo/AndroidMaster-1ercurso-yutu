...
import com.sgrab.androidmaster.imccalculator.ImcCalculatorActivity.Companion.IMC_KEY
    ...
    private fun initUI(result: Double) {
        ...
        when (result) {
            ...
            in 18.51..24.99 -> { // Peso normal
                ...
                tvResult.setTextColor(ContextCompat.getColor(this, R.color.normal_peso))
